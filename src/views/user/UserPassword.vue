    ...
    <el-row>
      <el-col :span="12">
        <el-form
          ...
          label-width="100px"
        >
          <el-form-item label="原密码" prop="old_pwd" style="width: 600px; ">
            <el-input v-model="pwdForm.old_pwd" show-password style="height: 40px;" ></el-input>
          </el-form-item>
          <el-form-item label="新密码" prop="new_pwd" style="width: 600px; ">
            <el-input v-model="pwdForm.new_pwd" show-password style="height: 40px;"></el-input>
          </el-form-item>
          <el-form-item label="确认密码" prop="re_pwd" style="width: 600px; ">
            <el-input v-model="pwdForm.re_pwd" show-password style="height: 40px;"></el-input>
          </el-form-item>
          <el-form-item>
